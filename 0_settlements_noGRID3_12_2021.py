...
##Concave Hull
#def concave(in_fn,out_fn):
#    processing.run("qgis:knearestconcavehull", {'INPUT':in_fn,\
#    'KNEIGHBORS':20,'FIELD':'CLUSTER_ID','OUTPUT':out_fn})
#in_fn = dir+cc+"/comms/"+cc+"_raspoints_clus_nonull.gpkg"
#out_fn = dir+cc+"/comms/"+cc+"_clus_concave.gpkg"
#concave(in_fn, out_fn)
